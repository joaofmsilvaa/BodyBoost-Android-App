...
@section('content')
    ...
    <div class="flex justify-center mt-8 p-8">
        <div class="p-8 w-3/4 justify-center bg-gray-50 rounded-xl">
            <h1 class="text-xl text-red-500">Create News</h1>
            <form method="POST" action="/admin/news/create/" enctype="multipart/form-data">
                ...
                <x-form.formInput name="title" placeholder="News title..."/>

                <div class="mt-3">
                    <label for="slug"
                           class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Slug</label>
                    <x-form.formInput name="slug" placeholder="A slug..."/>
                </div>

                <div class="mt-3">
                    <label for="slug"
                           class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Source</label>
                    <x-form.formInput name="source" placeholder="Source url..."/>
                </div>
                ...
                <div class="mt-3">
                    ...
                    <x-form.textarea name="body" placeholder="Yesterday in the 20th of October..."></x-form.textarea>
                </div>
